...
num_epochs = 500
batch_size = 30
learning_rate = 0.001#  0.000000001 #   for DIFF = False
...
# Load video tensor
data = torch.load('/home/jiawenb/CS229/cs229-project/Data/video_tensor.pt')
print(data.shape)
# data minus 128
# data = data - 128

# Load labels
labels = np.loadtxt('/home/jiawenb/CS229/cs229-project/Data/train.txt')
